...
/*
    숫자 타입으로 형변환
    - (+)연산자를 제외한 나머지 산수 연산 혹은 대소 비교 연산에 대하여 좌우항 중 하나라도 숫자가 아닌 항을 숫자 타입으로 변경하여 연산을 진행 
*/
console.log('1'-0); // '1'은 숫자 1로 형변환됨
...
/*
    불리언 타입으로 형변환
    - '', 0, -0, NaN, null, undefined는 false, 그 이외에 데이터에 대해서는 true로 변경하여 연산을 진행
*/
...
/*
    불리언 타입으로 형변환
    - Boolean 클래스의 생성자를 new연산자 없이 사용
    - !! 사용 가능
*/
