...
/* 
    ...
    - double의 값이 문자열이여도 값이 같다고 인식하여 true로 출력된다.
    - ==가 아닌 ===으로 하면 타입도 같아야 true로 인식됨.
*/
// console.log(integer === double); //터미널에 똒같이 입력하면 true가 나온다.(연결경로 필수 확인)
